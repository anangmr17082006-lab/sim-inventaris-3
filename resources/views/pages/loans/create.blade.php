    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-2">
                ...
                <span class="text-slate-800">Form Peminjaman</span>
            </div>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-slate-100 p-8">
                ...
                <div class="mb-8 border-b border-slate-100 pb-6">
                    <h3 class="text-xl font-bold text-slate-800">Form Peminjaman Aset</h3>
                    <p class="text-sm text-slate-500 mt-1">Isi data peminjaman dengan lengkap.</p>
                </div>
                ...
                <form action="{{ route('peminjaman.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        <label class="block font-medium text-sm text-slate-700 mb-2">Pilih Aset (Hanya yang
                            Tersedia)</label>
                        <select name="asset_detail_id"
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-6">
                        <div>
                            <label class="block font-medium text-sm text-slate-700 mb-2">Nama Peminjam</label>
                            <input type="text" name="borrower_name"
                                class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                required>
                        </div>
                        <div>
                            <label class="block font-medium text-sm text-slate-700 mb-2">NIM / NIP</label>
                            <input type="text" name="borrower_id"
                                class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                required>
                        </div>
                        <div class="col-span-2">
                            <label class="block font-medium text-sm text-slate-700 mb-2">No. HP / WA</label>
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-6">
                        <div>
                            <label class="block font-medium text-sm text-slate-700 mb-2">Tanggal Pinjam</label>
                            <input type="date" name="loan_date" value="{{ date('Y-m-d') }}"
                                class="w-full border-slate-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                        </div>
                        <div>
                            <label class="block font-medium text-sm text-slate-700 mb-2">Rencana Kembali</label>
                    ...
                    <div class="mb-8">
                        <label class="block font-medium text-sm text-slate-700 mb-2">Keperluan</label>
