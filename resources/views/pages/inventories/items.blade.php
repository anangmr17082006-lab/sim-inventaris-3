            ...
            <div class="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-slate-500">
                        <thead
                            class="text-xs text-slate-500 uppercase bg-slate-50 border-b border-slate-100 font-bold tracking-wider">
                            <tr>
                                <th class="px-6 py-4">Nama Aset</th>
                                <th class="px-6 py-4 text-center">Total Unit</th>
                                <th class="px-6 py-4">Kondisi (Baik/Ringan/Berat)</th>
                                ...
                                <tr class="bg-white hover:bg-slate-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        @if($item->total_unit > 0)
                                            <span
                                                class="bg-indigo-50 text-indigo-700 text-sm font-bold px-3 py-1 rounded-full border border-indigo-100">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex gap-2">
                                            {{-- Baik --}}
                                            <div class="flex flex-col items-center p-1 bg-emerald-50 rounded border border-emerald-100 min-w-[40px]"
                                                title="Kondisi Baik">
                                                <span class="text-[9px] text-emerald-600 font-bold uppercase">Baik</span>
                                                <span
                                                    class="text-sm font-bold text-emerald-700">{{ $item->baik ?? 0 }}</span>
                                            </div>

                                            {{-- Rusak Ringan --}}
                                            <div class="flex flex-col items-center p-1 bg-amber-50 rounded border border-amber-100 min-w-[40px]"
                                                title="Rusak Ringan">
                                                <span class="text-[9px] text-amber-600 font-bold uppercase">Rgn</span>
                                                <span
                                                    class="text-sm font-bold text-amber-700">{{ $item->rusak_ringan ?? 0 }}</span>
                                            </div>

                                            {{-- Rusak Berat --}}
                                            <div class="flex flex-col items-center p-1 bg-rose-50 rounded border border-rose-100 min-w-[40px]"
                                                title="Rusak Berat">
                                                <span class="text-[9px] text-rose-600 font-bold uppercase">Brt</span>
                                                <span
                                                    class="text-sm font-bold text-rose-700">{{ $item->rusak_berat ?? 0 }}</span>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center justify-center opacity-50">
                                            ...
                                            <p class="text-slate-500 text-sm mt-1">Coba kata kunci lain atau tambahkan aset
                                                baru.</p>
                                        </div>
                                    </td>
                                </tr>
